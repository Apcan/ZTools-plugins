...
await processor.mergeImages([first, second], joined, {
  layout: "horizontal",
  gap: 4,
  background: "#ffffff"
});
await processor.createGif([first, second], gif, {
  width: 48,
  height: 32,
  delayMs: 100,
  loop: 0,
...
if (joinedMeta.format !== "png" || joinedMeta.width !== 196 || joinedMeta.height !== 64) {
